...
fun ProfessionalInformationCard(){
    ...
    val specifications = listOf( "Cardiology", "Pediatrics", "Radiology")
    ...
    val options = listOf("Full time", "Intern", "Contract")
    ...
    Column(
        ...
        Text(text = "Professional Information", fontWeight = FontWeight.SemiBold, fontSize = 20.sp)
        ...
        Column{
            Spacer(modifier = Modifier.height(8.dp))
            Text(text = "Date of Joining", style = TextStyle(fontSize = 16.sp), fontWeight = FontWeight.SemiBold)
            Spacer(modifier = Modifier.height(8.dp))
            DatePickerExample(placeholder = "Date of Joining")
        }
        Spacer(modifier = Modifier.height(12.dp))
        Row(
            modifier = Modifier.fillMaxWidth(),
        ...
        Spacer(modifier = Modifier.height(12.dp))
        Column {
            Text(text = "Employment Type", style = TextStyle(fontSize = 16.sp), fontWeight = FontWeight.SemiBold)
            Spacer(modifier = Modifier.height(8.dp))
...
//    ) {
//        Text(
//            text = if (selectedDate.isEmpty()) "Select Established Date" else "$selectedDate",
